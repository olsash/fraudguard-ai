...
const steps = [
  { icon: Database, title: "Dataset", desc: "284,807 transactions · 492 fraudulent (0.172%). Kaggle Credit Card dataset + simulated stream.", stat: "284,807 rows" },
  { icon: Sparkles, title: "Data Cleaning", desc: "Removed duplicates, handled missing values, fixed type inconsistencies and outliers via IQR capping.", stat: "0 NaN" },
  { icon: Wrench, title: "Preprocessing", desc: "StandardScaler on Amount & Time, one-hot encoded categoricals, SMOTE oversampling on minority class.", stat: "SMOTE 1:1" },
  { icon: Layers, title: "Feature Engineering", desc: "Created velocity features, geo distance, time-of-day risk, merchant frequency, behavioral drift score.", stat: "31 features" },
  { icon: Brain, title: "Model Training", desc: "Trained 6 algorithms (LR, DT, RF, SVM, KNN, NN) with 5-fold cross-validation and grid search.", stat: "6 models" },
  { icon: GaugeCircle, title: "Evaluation", desc: "Compared accuracy, precision, recall, F1, ROC-AUC and confusion matrices on 30k hold-out set.", stat: "AUC 0.998" },
  { icon: Send, title: "Prediction API", desc: "Best model exported as ONNX, served via ASP.NET Core Web API with 12ms median latency.", stat: "12 ms p50" },
  { icon: Globe, title: "Web Integration", desc: "React dashboard consumes API in real time, displaying decisions, explanations and audit trails.", stat: "Live" },
];
