...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "SentinelAI — AI-Powered Credit Card Fraud Detection" },
      { name: "description", content: "Real-time machine learning fraud prevention platform for banks and fintech. Detect suspicious transactions instantly with 99.41% accuracy." },
      { property: "og:title", content: "SentinelAI — AI-Powered Fraud Detection" },
      { property: "og:description", content: "Real-time ML fraud prevention with 99.41% accuracy." },
    ],
  }),
  component: Landing,
});
    ...
    <header className="sticky top-0 z-50 border-b border-border bg-background/60 backdrop-blur-xl">
      <div className="mx-auto max-w-7xl flex items-center justify-between px-6 h-16">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/app" className="text-sm bg-gradient-primary text-primary-foreground rounded-lg px-4 py-2 font-medium ring-glow hover:opacity-95">
            Launch App
          </Link>
        </div>
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-20 pb-24 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h1 className="mt-5 text-5xl md:text-6xl font-display font-semibold leading-[1.05] tracking-tight">
            AI-Powered <span className="text-gradient">Credit Card Fraud</span> Detection.
          </h1>
          <p className="mt-5 text-lg text-muted-foreground max-w-xl">
            Advanced machine learning that flags suspicious financial transactions
            in real time — built on neural networks, ensemble models, and behavioral analytics.
          </p>
...
function Testimonials() {
  const t = [
    { q: "SentinelAI cut our chargeback rate by 71% in three months.", a: "Maya Lindgren", r: "Head of Risk, NORDBANK" },
    ...
    <footer className="border-t border-border mt-10">
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-7xl px-6 py-4 flex justify-between text-xs text-muted-foreground">
          <p>© 2026 SentinelAI · Bachelor thesis research project</p>
